...
class NeighborhoodsControllerTest < ActionController::TestCase
  ...
  test "should create neighborhood" do
    assert_difference('Neighborhood.count') do
      post :create, neighborhood: { description: @neighborhood.description, geometry: @neighborhood.geometry, name: @neighborhood.name }
    end
  ...
  test "should update neighborhood" do
    patch :update, id: @neighborhood, neighborhood: { description: @neighborhood.description, geometry: @neighborhood.geometry, name: @neighborhood.name }
    assert_redirected_to neighborhood_path(assigns(:neighborhood))
  end
